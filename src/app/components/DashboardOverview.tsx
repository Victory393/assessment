  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 overflow-y-auto pb-8">
        ...
        {/* Chart + Quick Actions */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 sm:px-6 lg:px-15">
          <div className="lg:col-span-2 card p-4 sm:p-6 my-4 h-70 rounded-xl text-xs text-gray-900 bg-white">
          ...
          {/* Quick Actions */}
          <div className="bg-white p-4 sm:p-8 flex flex-col space-y-2 max-h-70 rounded-xl my-4">
            <span className="font-semibold text-gray-900">Quick Actions</span>
            {[1, 2, 3, 4].map((n) => (
              <button
                key={n}
                className="border rounded-md p-2 border-gray-900 text-gray-900 w-full sm:w-80"
              >
                Hello
              </button>
            ))}
