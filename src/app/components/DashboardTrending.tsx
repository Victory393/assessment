    ...
    const [regionFilter, setRegionFilter] = useState<string | null>(null);
      ...
      <div className="flex h-screen bg-gray-100">
        ...
        <main className="flex-1 overflow-y-auto pb-8">
          ...
          {/* So this is my search bar and filter logic */}
          
          <div className="flex flex-wrap items-center justify-between gap-4 py-4 pr-18 pl-10">
            ...
            {["Bokku-Region 1", "Bokku-Region 2", "Bokku-Region 3"].map((region) => (
            <button
            key={region}
        ...
        className="border border-gray-200 rounded-md bg-white w-sm px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
      </div>
